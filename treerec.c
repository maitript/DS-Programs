...
// A function to display the nodes of BST
...
//A function to insert a node in the BST
...
//function to delete a node given its key value
...
//A function to search a node given its key value
